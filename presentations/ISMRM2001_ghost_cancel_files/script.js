...
var gDocTable = new Array(
   ...
   new hrefList("slide0090.htm", 1, 2),
   new hrefList("slide0061.htm", 1, 3),
   new hrefList("slide0080.htm", 1, 4),
   new hrefList("slide0088.htm", 1, 5),
   new hrefList("slide0089.htm", 1, 6),
   new hrefList("slide0101.htm", 1, 7),
   new hrefList("slide0102.htm", 1, 8),
   new hrefList("slide0070.htm", 1, 9),
