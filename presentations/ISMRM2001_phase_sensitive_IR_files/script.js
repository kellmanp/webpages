...
var gDocTable = new Array(
   ...
   new hrefList("slide0089.htm", 1, 2),
   new hrefList("slide0091.htm", 1, 3),
   new hrefList("slide0076.htm", 1, 4),
   new hrefList("slide0093.htm", 1, 5),
   new hrefList("slide0092.htm", 1, 6),
   new hrefList("slide0087.htm", 1, 7),
   new hrefList("slide0088.htm", 1, 8),
   new hrefList("slide0097.htm", 1, 9)
);
